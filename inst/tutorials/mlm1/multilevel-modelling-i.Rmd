...
### Activity
Use the [interactive Shiny app](https://cbdrh.shinyapps.io/mlm1/) to connect ideas between multilevel data, multilevel models, and fitting and interpreting models in R. The app can also be launched by entering `hdat9700tutorials::run('mlm1')` at the console. 
