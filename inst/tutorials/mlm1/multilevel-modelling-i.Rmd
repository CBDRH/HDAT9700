...
description: "Learn when to use multilevel models and how to fit and interpret basic multilevel models in R"
---
...
The pre-reading for this chapter is [Murder, muddled thinking and multilevel modelling by Martin Cartwright, Gemma Traviss and Andrew Blance, The Psychologist (2012) Vol 25 No 9](https://thepsychologist.s3.eu-west-2.amazonaws.com/articles/pdfs/0912cart.pdf?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIA3JJOMCSRX35UA6UU%2F20200908%2Feu-west-2%2Fs3%2Faws4_request&X-Amz-Date=20200908T031225Z&X-Amz-SignedHeaders=Host&X-Amz-Expires=10&X-Amz-Signature=137981da00a71118898f3b27b62d4bcdab85113de23be9861887ccc03847d9af) 
...
Consider a simple multilevel model: a two-level hierarchy with no explanatory variables:
$$
...
### Activity
Use the [interactive Shiny app](https://cbdrh.shinyapps.io/mlm1/) to connect ideas between multilevel data, multilevel models, and fitting and interpreting models in R. The app can also be launched by entering `hdat9700tutorials::run('mlm-1')` at the console. 
