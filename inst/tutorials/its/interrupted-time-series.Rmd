...
belt <- append(rep(0,sum(zoo::as.Date(UKDD)<'1983-02-01')),rep(1,sum(zoo::as.Date(UKDD)>='1983-02-01'))) %>% ts(start=c(1975,1), frequency=12)
UKDD.time <- seq(1, length(UKDD)) %>% ts(start=c(1975,01), frequency=12)
belt.after <- append(rep(0,sum(zoo::as.Date(UKDD)<'1983-02-01')),seq(1,sum(zoo::as.Date(UKDD)>='1983-02-01')))%>% ts(start=c(1975,01), frequency=12)
belt.lag <- append(rep(0,sum(zoo::as.Date(UKDD)<'1983-03-01')),rep(1,sum(zoo::as.Date(UKDD)>='1983-03-01'))) %>% ts(start=c(1975,1), frequency=12)
belt.after.lag <- append(rep(0,sum(zoo::as.Date(UKDD)<'1983-03-01')),seq(1,sum(zoo::as.Date(UKDD)>='1983-03-01')))%>% ts(start=c(1975,01), frequency=12)
...
step <- append(rep(0,sum(zoo::as.Date(alp)<'2017-02-01')),rep(1,sum(zoo::as.Date(alp)>='2017-02-01')))
time <- seq(from=1, to=length(alp))
after <- append(rep(0,sum(zoo::as.Date(alp)<'2017-02-01')), seq(1,sum(zoo::as.Date(alp)>='2017-02-01')))
step.lag1 <- append(rep(0,sum(zoo::as.Date(alp)<'2017-03-01')),rep(1,sum(zoo::as.Date(alp)>='2017-03-01')))
after.lag1 <- append(rep(0,sum(zoo::as.Date(alp)<'2017-03-01')), seq(1,sum(zoo::as.Date(alp)>='2017-03-01')))
...
quet.step <- ts(append(rep(0,sum(zoo::as.Date(quet)<'2014-01-01')),rep(1,sum(zoo::as.Date(quet)>='2014-01-01'))), start=c(2011,1), frequency=12)
quet.ramp <- ts(append(rep(0,sum(zoo::as.Date(quet)<'2014-01-01')),seq(1,sum(zoo::as.Date(quet)>='2014-01-01'))), start=c(2011,1), frequency=12)
...
belt <- append(rep(0,sum(as.Date(UKDD)<='1983-01-01')), rep(1,sum(as.Date(UKDD)>'1983-01-01')))
...
belt.after <- append(rep(0,sum(as.Date(UKDD)<'1983-02-01')), seq(1,sum(as.Date(UKDD)>='1983-02-01'))) %>% ts(start=c(1975,1), frequency=12)
print(belt.after)
```
...
belt.lag <- append(rep(0,sum(as.Date(UKDD)<='1983-02-01')), rep(1,sum(as.Date(UKDD)>'1983-02-01'))) %>% ts(start=c(1975,01), frequency=12)
print(belt.lag)

# Create vector for time since intervention
belt.after.lag <- append(rep(0,sum(as.Date(UKDD)<='1983-02-01')), seq(1,sum(as.Date(UKDD)>'1983-03-01'))) %>% ts(start=c(1975,01), frequency=12)
...
Note that `as.Date()` doesn't work with `abline()` - so instead we'll use the numeric version of the date. If you aren't sure what that is, you can check using `time()`.
...
step <- append(rep(0,sum(as.Date(alp)<'2017-02-01')),rep(1,sum(as.Date(alp)>='2017-02-01')))
...
after <- append(rep(0,sum(as.Date(alp)<'2017-02-01')),seq(1,sum(as.Date(alp)>='2017-02-01'),1))
```
...
# Step change - note, with "as.Date" you need to specify the entire 
sp.vax <- append(rep(0,sum(time(sp)<'1796')), rep(1,sum(time(sp)>='1796')))
sp.vax
...
# Model your time series "alp" using a combination of a step change and slope change
...
```{r exercise3_5, exercise=TRUE, exercise.cap="Exercise 3.5", exercise.eval=FALSE, exercise.lines=8}
...
# Run the same model using ARIMA - remember you don't need the variable representing time or seasonality - and prespecify "d" and "D"
auto.arima( )
