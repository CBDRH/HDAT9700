...
![**Figure 1.5.** Examples of intervention impacts](images/types of impacts.png)
...
* $i$ = the length of the series.

The time variable ($T_t$) is a sequence from 1 to $i$.
$$T_t=  1,2,3,...i $$
...
$$ R_t =  \begin{cases} 0, & \text{if} \;t<T_I \\1,2,3,...i, & \text{if}\;t \geq T_I \end{cases} $$
...
The model fits looks good, and the Ljung-Box test is nonsignificant at all lags.
...
* The step change variable represents an immediate reduction in dispensings (-3285, 95% CI -4465 to -2104) that was sustained for the duration of the study period;
