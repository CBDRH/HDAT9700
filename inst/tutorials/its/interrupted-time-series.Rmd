...
belt <- append(rep(0,sum(as.Date(UKDD)<'1983-02-01')),rep(1,sum(as.Date(UKDD)>='1983-02-01'))) %>% ts(start=c(1975,1), frequency=12)
UKDD.time <- seq(1, length(UKDD)) %>% ts(start=c(1975,01), frequency=12)
belt.after <- append(rep(0,sum(as.Date(UKDD)<'1983-02-01')),seq(1,sum(as.Date(UKDD)>='1983-02-01')))%>% ts(start=c(1975,01), frequency=12)
belt.lag <- append(rep(0,sum(as.Date(UKDD)<'1983-03-01')),rep(1,sum(as.Date(UKDD)>='1983-03-01'))) %>% ts(start=c(1975,1), frequency=12)
belt.after.lag <- append(rep(0,sum(as.Date(UKDD)<'1983-03-01')),seq(1,sum(as.Date(UKDD)>='1983-03-01')))%>% ts(start=c(1975,01), frequency=12)
...
after <- append(rep(0,sum(as.Date(alp)<'2017-02-01')), seq(1,sum(as.Date(alp)>='2017-02-01')))
step.lag1 <- append(rep(0,sum(as.Date(alp)<'2017-03-01')),rep(1,sum(as.Date(alp)>='2017-03-01')))
after.lag1 <- append(rep(0,sum(as.Date(alp)<'2017-03-01')), seq(1,sum(as.Date(alp)>='2017-03-01')))
...
quet.step <- ts(append(rep(0,sum(as.Date(quet)<'2014-01-01')),rep(1,sum(as.Date(quet)>='2014-01-01'))), start=c(2011,1), frequency=12)
quet.ramp <- ts(append(rep(0,sum(as.Date(quet)<'2014-01-01')),seq(1,sum(as.Date(quet)>='2014-01-01'))), start=c(2011,1), frequency=12)
