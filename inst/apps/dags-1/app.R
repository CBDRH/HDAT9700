    ...
    sidebarLayout(
        ...
        sidebarPanel(width=4,
            ...
            p("The data generation parameters are summarised below, and some of these can be adjusted. Importantly, there is one key difference between the two scenarios.
                ...
                people regularly taking aspirin may be doing so because they have an underlying risk factor like high blood pressure."),
        ...
        mainPanel(width=8,
            ...
            fluidRow(
                column(width = 6,
                       ...
                       p("Scenario A reflects a randomised control trial exploring the causal effect of aspirin use on pulmonary embolism.
                            Participants have been randomised to receive antibiotics (treated) or a placebo pill (control)"),
                       br(),
                       p(HTML(paste0("The DAG below represents this data generation mechanism (you should try drawing it before revealing the solution). In this scenario,
                       aspirin use is controlled by the researchers, and randomised to a large number of subjects. Aspirin use decreases the risk of
                                     pulmonary embolism (tx", "&rarr;", "pe); and high blood pressure increases the risk of pulmonary embolism (hbp", "&rarr;", "pe)."))),
                ...
                column(width = 6,
                       ...
                       h4("Data generation mechanism"),
                       p("Scenario B reflects an observational data analysis where assignment to the exposure of interest (aspirin use) is not under the control of the researchers."),
                       br(),
                       p(HTML(paste0("The data are generated to reflect this: high blood pressure increases the likelihood of aspirin use (hbp", "&rarr;", "tx); aspirin use decreases the risk of
                                     pulmonary embolism (tx", "&rarr;", "pe); and high blood pressure increases the risk of pulmonary embolism (hbp", "&rarr;", "pe). The strength of these relationships
                                     underlying the data generation mechanism can be controlled in the panel on the left." )))
                )
                ), # Closes fluid row
                    ...
                    column(width = 6,
                           tabsetPanel(
                               ...
                               tabPanel("See the solution", icon = icon("project-diagram"),
                                       ...
                                       This results in a backdoor path between our treatment tx and exposure pe (the path tx", "&larr;", "hbp", "&rarr;", "pe).",
            ...
            br(),
            fluidRow(
                tags$blockquote("The key point to recognise here is that you can have the same research question and the same potential model covariates
                                available, but the specifying the correct model to answer the causal question at hand depends on understanding the causal
